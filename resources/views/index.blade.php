                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-10 col-12 d-flex flex-column justify-content-center align-items-center">
                              <div class="hero-text">
                                   ...
                                   <h2 class="text-white" data-aos="fade-up">Apakah Anda Sudah Terdaftar MBR Kota Surabaya?</h2>

                                   <div class="text-white">
                                    <i class="fa fa-user-circle"></i>
                                        <input type="text" class="form-control" id="formGroupExampleInput" placeholder="NIK (Nomor Induk KTP)">
                                   </div>
                                   <a href="contact.html" class="custom-btn btn-bg btn mt-3" data-aos="fade-up" data-aos-delay="100">Cek Data</a>

                                   {{-- <strong class="d-block py-3 pl-5 text-white" data-aos="fade-up" data-aos-delay="200"><i class="fa fa-id-badge">
                                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="NIK (Nomor Induk KTP)"></i> 
                                </strong> --}}
                              </div>
                        </div>

                        <div class="col-lg-6 col-12 ">
                          <div class="hero-image" style="" data-aos="fade-up" data-aos-delay="300">

                          
                            <img src="images/2.png" class="img-fluid" alt="Dinas Kota Surabaya">
                          </div>
                        </div>
