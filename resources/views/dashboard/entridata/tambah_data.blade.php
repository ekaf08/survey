                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="16" class="form-control" id="noKK" name="noKK"
                                    value="{{ $warga->no_kk }}" readonly required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="16" class="form-control"  id="nik" name="nik"
                                    value="{{ $warga->nik }}" readonly  required>
                                @endforeach
                            </div>
                        </div>
...
{{-- Radio Button --}}
                        ...
                        <div class="col-md-10" id="div_status" style="display:none">
                            <fieldset class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="catatan" id="catatan" value="{{ $warga->catatan }}" ></textarea>
                                </div>
                            </div>
                        </div>
